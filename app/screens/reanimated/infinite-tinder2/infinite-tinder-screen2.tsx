...
export const InfiniteTinderScreen2 = observer(function InfiniteTinderScreen2() {
  ...
  const onSwipe = useCallback(
    (index, id) => {
      ...
      // extraRightOffset.value = withTiming(extraRightOffset.value + 10) // not perfect
      console.log("swipe")
    },
